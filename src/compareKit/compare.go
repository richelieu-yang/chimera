...
(1) 如果传参结构体（或其内部的结构体）实现了 "(T) EqualWithTypeAndValue(T) bool" 或者 "(T) EqualWithTypeAndValue(I) bool"，
...
e.g.
	...
	fmt.Println(compareKit.EqualWithTypeAndValue(p1, p2)) // false
	fmt.Println(compareKit.EqualWithTypeAndValue(p1, p3)) // true
*/
